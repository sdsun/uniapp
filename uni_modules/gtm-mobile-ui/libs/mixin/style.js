export default {
  ...
  methods: {
    ...
    getUnit(unit = '') {
      ...
      return uni.$g.trim(unit).split(' ').map((item) => uni.$g.addUnit(item)).join(' ')
    }
  }
}
